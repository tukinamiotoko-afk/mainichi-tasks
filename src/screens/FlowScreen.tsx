...
const makeStyles = (C: ColorSet) => StyleSheet.create({
  ...
  branchYesWrap: { width: 58, height: 110, alignItems: 'center', justifyContent: 'center', position: 'relative' },
  branchYesLine: { width: 2, height: 110, backgroundColor: C.line, marginTop: 0 },
  ...
  branchNoMergeLine: { position: 'absolute', top: 190, left: '50%', width: 2, height: 30, backgroundColor: C.line, zIndex: 1 },
  ...
  viewBranchYesWrap: { width: 50, height: 90, alignItems: 'center', justifyContent: 'center', position: 'relative' },
  viewBranchYesLine: { width: 2, height: 90, backgroundColor: C.line, marginTop: 0 },
  ...
  viewBranchNoMergeLine: { position: 'absolute', top: 152, left: '50%', width: 1.5, height: 32, backgroundColor: C.line, zIndex: 1 },
