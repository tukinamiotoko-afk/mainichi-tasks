...
const makeStyles = (C: ColorSet) => StyleSheet.create({
  ...
  branchNoRoute: { position: 'absolute', top: 40, left: '50%', marginLeft: 28, width: 234, height: 150, zIndex: 1 },
  ...
  viewBranchNoRoute: { position: 'absolute', top: 30, left: '50%', marginLeft: 24, width: 220, height: 122, zIndex: 1 },
  ...
  subYesReturnLineWide: { left: -143, width: 143 },
  subYesReturnLineCompact: { left: -129, width: 129 },
  ...
  subYesReturnLabelWide: { left: -71 },
  subYesReturnLabelCompact: { left: -64 },
